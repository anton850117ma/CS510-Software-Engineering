...
public class Main {
    public static void main(String[] args) {
        ...
        else bugKiller = new BugKiller(file, Integer.parseInt(args[1]), Integer.parseInt(args[2]), Integer.parseInt(args[3]));
        ...
        for (String caller : callSites.keySet()) {
            ...
            for (String callee : calleeSet) {
                ...
                for (Partner partner : partners) {
                    if (!calleeSetInlined.contains(partner.name)) {
