...
# from tensorflow.keras.layers.SimpleRNNCell import get_recurrent_dropout_mask_for_cell
# from tensorflow.keras.layers.GRU import get_dropout_mask_for_cell
# from tensorflow.keras.layers.recurrent import _generate_dropout_mask
...
class IndRNNCell(Layer):
    ...
    def call(self, inputs, states, training=None):
        ...
        #     self._dropout_mask = get_recurrent_dropout_mask_for_cell(
        #         K.ones_like(inputs),
        #         self.dropout,
        #         training=training,
        #         count=1)
        ...
        #     _recurrent_mask = get_recurrent_dropout_mask_for_cell(
